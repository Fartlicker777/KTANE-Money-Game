...
public class MoneyGame : MonoBehaviour {
   ...
   void Start () {
      ...
      Lyrics.Add(new List<string> { "You", "must", "create", "a", "sense", "of", "scarcity", "Shells", "will", "sell", "much", "better", "if", "the", "people", "think", "they\'re", "rare", "you", "see", "bare", "with", "me", "and", "take", "as", "many", "shells", "as", "you", "can", "find", "and", "hide", "\'em", "on", "an", "island", "stock", "pile", "\'em", "high", "until", "they\'re", "rarer", "than", "a", "diamond" }.Select(x => x.ToLower()).Distinct().ToList());
